        ...
        <div className="grid lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-8 bg-white border border-slate-100 rounded-[3.5rem] p-8 md:p-16 shadow-2xl shadow-slate-200/50 relative overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    required
                    type="text"
                    className="w-full bg-slate-50 border border-slate-200 text-black font-medium rounded-2xl px-6 py-4 outline-none focus:border-[#31008e] focus:bg-white transition-all"
                  />
                </div>
              ...
              {/* Class Applying For - Added text-black */}
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-2">Class Applying For *</label>
                <select
                  name="className"
                  required
                  className="w-full bg-slate-50 border border-slate-200 text-black font-medium rounded-2xl px-6 py-4 outline-none focus:border-[#31008e] transition-all"
                >
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full bg-slate-50 border border-slate-200 text-black font-medium rounded-[2rem] px-6 py-6 h-40 resize-none outline-none focus:border-[#31008e]"
                />
              ...
              <div className="space-y-4">
                ...
                {status.type && (
                  <div className={`p-4 rounded-2xl text-center font-bold text-sm ${status.type === 'success'
